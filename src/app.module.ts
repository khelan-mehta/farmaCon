...
import {
  DesignCodeModel,
  DesignCodeSchema,
} from './database/models/designcode.model';
...
@Module({
  imports: [
    MongooseModule.forRoot(
      'mongodb+srv://khelan05:dXsHbmSERKGhXBya@farmaconnect.uvzvn.mongodb.net/?retryWrites=true&w=majority&appName=farmaConnect',
    ),
